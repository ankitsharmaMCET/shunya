...
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental) [![CRAN status](https://www.r-pkg.org/badges/version/IDEEA.dev)](https://CRAN.R-project.org/package=IDEEA.dev)
...
You can install the development version of IDEEA.dev from [GitHub](https://github.com/) with:
...
```{r example, eval=FALSE, warning=FALSE, message=FALSE}
library(IDEEA.dev)
## basic example code
```
